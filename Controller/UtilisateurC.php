<?php
    ...
    class UtilisateurC{
        ...
        public function triASC(){
            $sql="SELECT * FROM utilisateurs order by username ASC" ;
            $db = config::getConnexion() ;
            try {
                $liste = $db->query($sql) ;
                return $liste ;
        ...
        public function triDESC(){
            $sql="SELECT * FROM utilisateurs order by username DESC " ;
            $db = config::getConnexion() ;
            try {
                $liste = $db->query($sql) ;
                return $liste ;
        ...
        public function recherche($a){
            $sql="SELECT * FROM utilisateurs where nom_user like '%".$a."%' or prenom_user like '%".$a."%'" ;
            $db = config::getConnexion() ;
            try {
                $liste = $db->query($sql) ;
                return $liste ;
