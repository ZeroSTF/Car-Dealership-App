...
<br />
<div class="control-group <?php echo !empty( $idErrr)?'error':'';?>">
...
<div class="controls">
                            ...
                            <?php if (!empty($idErrr)): ?>
                                <span class="help-inline"><?php echo $idErrr;?></span>
                            <?php endif; ?>
</div>
<p>
...
<div class="control-group <?php echo !empty($prixErr)?'error':'';?>">
                        <label class="control-label">Heures reservations </label>

<br />
<div class="controls">
                            <input name="prix" type="number" placeholder="price" value="<?php echo !empty($prix)?$prix:'';?>">
