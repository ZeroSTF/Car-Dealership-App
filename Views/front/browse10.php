...
<li><a href="ajouterLivraison.php">Livraisons</a></li>				
   ...
   <div class="row">
      <div class="col-lg-12">
         <h2 class="text-center py-5 text-white">Cars </h2>
         <div class="items">
		...
		'</a>
               ...
               <div class="card-body">
                  <h3 class="text-left py-4  "> <img src="' . $row['bin'] .'"  style="width: 200px;height: 200px;"/> </h3>
                  <p class="lead">'. $row['description'] .'</p>
				  <span class="ml-2"> Prix :'. $row['prix'] .'  </span> 
