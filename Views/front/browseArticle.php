...
<li><a href="ajouterLivraison.php">Livraisons</a></li>				
			...
			<body>
				...
				<div class="row">
									...
									<a href="browse12.php" class="btn btn-warning">Add car</a>
				...
				<td>';
											echo '<a class="btn" href="browse14.php?id=' . $row['id'] . '">Read</a>';// un autre td pour le bouton d'edition
											echo '</td>
				<p>
				';
											echo '
				...
				<td>';
											echo '<a class="btn btn-success" href="browse13.php?id=' . $row['id'] . '">Update</a>';// un autre td pour le bouton d'update
											echo '</td>
				<p>
				';
											echo'
				...
				<td>';
											echo '<a class="btn btn-danger" href="deletecar.php?id=' . $row['id'] . ' ">Delete</a>';// un autre td pour le bouton de suppression
											echo '</td>
				<p>
				';
											echo '</tr>
