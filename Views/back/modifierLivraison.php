...
if (
    ...
    if (
        ...
        $livraison = new Livraison($date_livraison,$id_livreur,$adresse_livraison,$id_commande);
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">modifier livraison</h4>

                                <form class="forms-sample" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">id:</label>
                                        <input readonly type="" class="form-control" name="id" id="exampleInputUsername1" value="<?php echo $livraison['id']; ?>" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">date livraison</label>
                                        <input type="date" class="form-control" name="date_livraison" id="exampleInputUsername1"  value="<?php echo $livraison['date_livraison']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">id livreur</label>
                                        <input type="number" name="id_livreur" class="form-control" id="exampleInputEmail1" value="<?php echo $livraison['id_livreur']; ?>" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">adresse livraison</label>
                                        <input type="text" class="form-control" name="adresse_livraison" id="exampleInputPassword1" value="<?php echo $livraison['adresse_livraison']; ?>" placeholder="Password">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">id commande</label>
                                        <input type="number" name="id_commande" value="<?php echo $livraison['id_commande']; ?>" class="form-control" id="exampleInputEmail1" >
                                    </div>
