                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" id="form"  onsubmit="event.preventDefault(); verif();">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date_livraison" id="exampleInputUsername1" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">id livreur</label>
                                        <input type="number" name="id_livreur" class="form-control" id="id_livreur" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">adresse livraison</label>
                                        <input type="text" class="form-control" name="adresse_livraison" id="adresse" placeholder="Password">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">id commande</label>
                                        <input type="number" name="id_commande" class="form-control" id="id_commande" >
                                    </div>
...
<script>
    ...
    function verif() {
        var idC = document.getElementById("id_commande").value;
        var adresse = document.getElementById("adresse").value;
        var idL = document.getElementById("id_livreur").value;
        ...
        if (idL < 0) {
            alert("id livreur doit etre positive");
