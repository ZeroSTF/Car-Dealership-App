...
if (
    ...
    if (
        ...
        $etat = $_POST['etat'] ;
    echo 'kkkk';
        $livreur = new Livreur(0,$nom,$prenom,$email,$etat); echo 'ooooo';
        $livreurC->modifier_Livreur($livreur,$_POST['id']);
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="" class="form-control" name="id" id="exampleInputUsername1" value="<?php echo $livreur['id']; ?>" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">nom</label>
                                        <input type="text" class="form-control" name="nom" id="nom"  value="<?php echo $livreur['nom']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">prenom</label>
                                        <input type="text" name="prenom" class="form-control" id="exampleInputEmail1" value="<?php echo $livreur['prenom']; ?>" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">email</label>
                                        <input type="email" class="form-control" name="email" id="exampleInputPassword1" value="<?php echo $livreur['email']; ?>" >
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">etat</label>
                                        <input type="text" name="etat" value="<?php echo $livreur['etat']; ?>" class="form-control" id="exampleInputEmail1" >
                                    </div>
