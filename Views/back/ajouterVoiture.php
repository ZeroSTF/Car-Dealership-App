...
$categories = $categorieC->afficher_categorie();
if(isset($_POST['matricule']) &&
    ...
    $voitureC->ajouter_Voiture($voiture);
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="post" id="form"  onsubmit="event.preventDefault(); verif();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="etat" id="etat" placeholder="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="consommation" id="consommation" >
                                    </div>
                                    <div class="form-group">
